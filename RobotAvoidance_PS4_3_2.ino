...
void setupPWM() {
  // Configure PWM for motor control using the older (deprecated) ledcAttach
  // This is required for older ESP32 Arduino Core versions
  ledcAttach(IN1, PWM_FREQ, PWM_RESOLUTION); // Attach IN1 to a PWM channel
  ledcAttach(IN2, PWM_FREQ, PWM_RESOLUTION); // Attach IN2 to a PWM channel
  ledcAttach(IN3, PWM_FREQ, PWM_RESOLUTION); // Attach IN3 to a PWM channel
  ledcAttach(IN4, PWM_FREQ, PWM_RESOLUTION); // Attach IN4 to a PWM channel
}
